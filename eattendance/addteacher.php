...
?>   
 <div class="container-fluid" style="background-color:#7ec6e6";>
          ...
          <h1 class="h1_index text-center">TEACHER BOARD</h1>
		   <br>
...
<form  action="insertemployee.php" method="POST">
 ...
 <div class="form-group">
   <label for="formGroupExampleInput">Registration Id:</label>
   <input type="text" name="id" class="form-control" id="formGroupExampleInput" placeholder="id">
 </div>
 <div class="form-group">
...
if(isset($_GET['view_employee'])) {
 ...
 <div class="container-fluid" style="background-color:#7ec6e6";>
    ...
    <div class="container-fluid" style="background-color:lavender">
          ...
          <h2 class="h1_index text-center">TEACHER DETAILS</h2>
...
while($post=mysqli_fetch_assoc($record)) {
   ...
   ?>
      ...
      <tr>
		...
		<td><a href="editteacher.php?edit=<?php echo $post['id']; ?>">edit</a></td>
		<td><a href="delteacher.php?delete=<?php echo $post['id']; ?>">delete</a></td>
      </tr>
